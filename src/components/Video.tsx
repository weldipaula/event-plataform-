        ...
        <div className="flex items-start gap-16">
          <div className="description flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              <img 
                src="https://github.com/weldipaula.png" 
                alt="imagem do github" 
                className="h-16 w-16 rounded-full border-2 border-blue-500"
              />
              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Wellyngton de Paula</strong>
                <span className="text-gray-200 text-sm block">Professor</span>
              </div>
            </div>
        ...
        <div className="gap-8 mt-20 grid grid-cols-2">
          <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
            ...
            <div className="py-6 leading-relaxed">
              <strong className="text-2xl">Material Complementar
              </strong>
          ...
          <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
            ...
            <div className="py-6 leading-relaxed">
              <strong className="text-2xl">Wallpapers exclusivos
              </strong>
              <p className="text-sm text-gray-200 mt-2">
                Acesse o material complementar para acelerar o seu desenvolvimento
              </p>
